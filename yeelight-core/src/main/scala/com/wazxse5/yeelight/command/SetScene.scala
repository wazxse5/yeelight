...
import com.wazxse5.yeelight.valuetype.{Parameter, SceneClass, SceneValue}

case class SetScene(p1: SceneClass, p2: SceneValue[_], p3: SceneValue[_], p4Opt: SceneValue[_]) extends YeelightCommand4 {
