...
case class DiscoveryMessage private (
  header: String,
  cacheControl: Int,
  date: String = "",
  ext: String = "",
...
object DiscoveryMessage {
  ...
  def apply(message: String): DiscoveryMessage = {
    ...
    new DiscoveryMessage(header, cacheControl, date, ext, location, server, id, model, firmwareVersion,
